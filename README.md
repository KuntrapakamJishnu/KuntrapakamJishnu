...
🔗 LinkedIn: https://www.linkedin.com/in/jishnu-k738/

---

## 🚀 About Me

I am a **Software Engineering and AI-focused graduate student** with hands-on experience in **building production-ready systems**, ranging from **AI-powered platforms** to **scalable full-stack applications**.

My interests lie at the intersection of **Artificial Intelligence, backend systems, and real-world problem solving**. I enjoy translating complex ideas into reliable, deployable software.

- 🔭 Current focus: **AI-driven systems, backend engineering, and applied ML**
- 🧠 Strong foundation in **DSA, OOP, DBMS, and system-oriented thinking**
- 🎯 Career goal: **Software Engineer / AI Engineer** working on impactful products
...
### **Frameworks & Tools**
`Flutter` · `React.js` · `Node.js` · `Express.js` · `FastAPI` · `Git` · `Docker`

### **Databases & Cloud**
`PostgreSQL` · `MongoDB` · `Firebase`

### **AI / ML**
`TensorFlow` · `LSTM` · `GRU` · `RAG`
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=KuntrapakamJishnu&show_icons=true&theme=tokyonight" height="150"/>
...
> *“I enjoy building systems where good engineering meets practical intelligence.”*  
